package com.project3.domain.rank.repository

import com.project3.domain.place.enums.Region
import com.project3.domain.post.entity.Post
import com.project3.domain.rank.dto.PopularPlaceDTO
import com.project3.domain.rank.dto.RegionRankingDTO
...
interface RankingRepository : JpaRepository<Post, Long> {
    ...
    @Query(
            """
        SELECT new com.project3.domain.rank.dto.PopularPlaceDTO(
    ...
    @Query(
            """
        SELECT new com.project3.domain.rank.dto.RegionRankingDTO(
            pl.region,
            COUNT(DISTINCT l.id),
            COUNT(DISTINCT s.id),
            COUNT(DISTINCT p.id)
