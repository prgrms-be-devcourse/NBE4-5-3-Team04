...
public class PostToggleController {
	...
	public RsData<LikeResponseDTO> toggleLike(@AuthenticationPrincipal SecurityUser securityUser,
		@PathVariable Long postId) {
		return postToggleService.toggleLikes(securityUser.getId(), postId);
	}

	@PostMapping("/{postId}/scrap")
	public RsData<ScrapResponseDTO> toggleScrap(@AuthenticationPrincipal SecurityUser securityUser,
		@PathVariable Long postId) {
