    ...
    return (
        <QueryClientProvider client={queryClient}>
            <div className="flex flex-col">
                {/* 헤더 (상단 고정) */}
                <header
                    className="bg-gray-300 flex justify-between items-center px-4 h-16 border-b border-gray-400 w-full fixed top-0 left-0 z-50">
                    {/* 로고 */}
                ...
                <div className="flex">
                    {/* 사이드바 (왼쪽 고정) */}
                    <aside
                        className="bg-gray-300 w-48 h-[calc(100vh-64px)] flex flex-col border-r border-gray-400 fixed top-16 left-0 z-40">
